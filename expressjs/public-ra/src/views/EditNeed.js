...
class EditNeed extends React.Component {
    ...
    componentDidMount() {
        const url = 'http://localhost:8080/api/need/edit/' + this.state.id + '';
        fetch(url)
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 mt-3 mx-auto">
                        <form action="/confirmNeed" method="POST" className="text-center border border-light p-5 rounded bg-blue">
